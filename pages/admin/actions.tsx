...
const Actions = () => {
    ...
    useEffect(() => {
        if (customersSelection.selected.length) {
    ...
    const rowConf = [
        ...
        {fieldName: 'email'},
        {handleFunc: (elem: any) => {return `${elem.address.street} ${elem.address.city}`}},
        {fieldName: 'phone'},
    ]

    const headConf = ["Name", "Email", "Location", "Phone"]
